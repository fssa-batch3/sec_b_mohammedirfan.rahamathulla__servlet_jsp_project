...
<body>
	...
	<form action=booking/create method="get">
		<label for="email">Email Id:</label> <input type="email" id="email"
			name="email" value="<%=email%>"> <label for="turfId">Turf
			ID:</label> <input type="text" id="turfId" name="turfId"
			value="<%=request.getParameter("turfId")%>"><br> <br>
		<label for="fromTime">From Time</label> <input type="time"
			id="fromTime" name="fromTime" min="00:00" max="23:59"
			value="<?php echo date('H:i'); ?>"> <br> <br> <label
			for="toTime">To Time</label> <input type="time" id="toTime"
			name="toTime" min="00:00" max="23:59"
			value="<?php echo date('H:i'); ?>"> <br> <br> <label
